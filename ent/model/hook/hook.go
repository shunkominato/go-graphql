...
type ArInternalMetadatumFunc func(context.Context, *model.ArInternalMetadatumMutation) (model.Value, error)

// Mutate calls f(ctx, m).
func (f ArInternalMetadatumFunc) Mutate(ctx context.Context, m model.Mutation) (model.Value, error) {
	if mv, ok := m.(*model.ArInternalMetadatumMutation); ok {
		return f(ctx, mv)
	}
...
type SchemaMigrationFunc func(context.Context, *model.SchemaMigrationMutation) (model.Value, error)

// Mutate calls f(ctx, m).
func (f SchemaMigrationFunc) Mutate(ctx context.Context, m model.Mutation) (model.Value, error) {
	if mv, ok := m.(*model.SchemaMigrationMutation); ok {
		return f(ctx, mv)
	}
