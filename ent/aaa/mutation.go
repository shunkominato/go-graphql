...
func (m ArInternalMetadatumMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("aaa: mutation is not running in a transaction")
	}
...
func withTodoID(id uint) todoOption {
...
func (m *TodoMutation) SetID(id uint) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *TodoMutation) ID() (id uint, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *TodoMutation) IDs(ctx context.Context) ([]uint, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
...
type TodoStatusMutation struct {
	...
	updated_at    *time.Time
	clearedFields map[string]struct{}
	todos         map[uint]struct{}
	removedtodos  map[uint]struct{}
	clearedtodos  bool
	done          bool
...
func (m *TodoStatusMutation) AddTodoIDs(ids ...uint) {
	if m.todos == nil {
		m.todos = make(map[uint]struct{})
	}
	for i := range ids {
...
func (m *TodoStatusMutation) RemoveTodoIDs(ids ...uint) {
	if m.removedtodos == nil {
		m.removedtodos = make(map[uint]struct{})
	}
	for i := range ids {
...
func (m *TodoStatusMutation) RemovedTodosIDs() (ids []uint) {
...
func (m *TodoStatusMutation) TodosIDs() (ids []uint) {
...
// AddTodoIDs adds the "todos" edge to the Todo entity by ids.
func (m *UserMutation) AddTodoIDs(ids ...uint) {
	if m.todos == nil {
		m.todos = make(map[uint]struct{})
	}
	for i := range ids {
...
// RemoveTodoIDs removes the "todos" edge to the Todo entity by IDs.
func (m *UserMutation) RemoveTodoIDs(ids ...uint) {
	if m.removedtodos == nil {
		m.removedtodos = make(map[uint]struct{})
	}
	for i := range ids {
...
// RemovedTodos returns the removed IDs of the "todos" edge to the Todo entity.
func (m *UserMutation) RemovedTodosIDs() (ids []uint) {
	for id := range m.removedtodos {
		ids = append(ids, id)
	}
	return
...
// TodosIDs returns the "todos" edge IDs in the mutation.
func (m *UserMutation) TodosIDs() (ids []uint) {
	for id := range m.todos {
		ids = append(ids, id)
	}
	return
