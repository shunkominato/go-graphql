...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	if _, ok := c.driver.(*txDriver); ok {
		return nil, errors.New("aaa: cannot start a transaction within a transaction")
	}
	tx, err := newTx(ctx, c.driver)
	if err != nil {
		return nil, fmt.Errorf("aaa: starting a transaction: %w", err)
	}
	cfg := c.config
	cfg.driver = tx
	return &Tx{
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("aaa: unknown mutation type %T", m)
	}
}
...
func (c *ArInternalMetadatumClient) mutate(ctx context.Context, m *ArInternalMetadatumMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("aaa: unknown ArInternalMetadatum mutation op: %q", m.Op())
	}
}
...
func (c *CompanyClient) mutate(ctx context.Context, m *CompanyMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("aaa: unknown Company mutation op: %q", m.Op())
	}
}
...
func (c *ExampleClient) mutate(ctx context.Context, m *ExampleMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("aaa: unknown Example mutation op: %q", m.Op())
	}
}
...
func (c *SchemaMigrationClient) mutate(ctx context.Context, m *SchemaMigrationMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("aaa: unknown SchemaMigration mutation op: %q", m.Op())
	}
}
...
func (c *TodoClient) mutate(ctx context.Context, m *TodoMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("aaa: unknown Todo mutation op: %q", m.Op())
	}
}
...
func (c *TodoStatusClient) mutate(ctx context.Context, m *TodoStatusMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("aaa: unknown TodoStatus mutation op: %q", m.Op())
	}
}
...
func (c *UserClient) mutate(ctx context.Context, m *UserMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("aaa: unknown User mutation op: %q", m.Op())
	}
}
